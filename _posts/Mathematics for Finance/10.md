...
where $$\phi_t = (\phi_t^0, \phi_t^1, \dots \phi_t^d)$$ is a vectors of holdings representing the assets held at time $$t$$. That is, $$\phi_t^I$$ is the number of shares of asset $$i$$ to be held on day $$t$$. 
...
**Lemma 3** If $$(M_t: t = 0, 1, \dots, T)$$ is a martingale and $$(H_1,H_2, \dots, H_T)$$ is a predictable sequence of random variables then 
